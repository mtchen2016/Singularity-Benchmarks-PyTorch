...
easy and hopefully, to make code more readable. Here, we will see 
how to load and preprocess/augment data from a non trivial dataset.

To run this code, please make sure the following packages are
installed:
...
#     generated by applying `dlib's pose
...
# ----------------------
#
# Here, we have seen how to write and use datasets, transforms
